    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { title: "Camisas de Time", href: "/produtos?genero=masculino&categoria=roupas&tipo=camisas-de-time" },
        ],
      },
      {
        title: "Acessórios",
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { title: "Camisas de Time", href: "/produtos?genero=feminino&categoria=roupas&tipo=camisas-de-time" },
        ],
      },
      {
        title: "Acessórios",
